function select(){
    var ele=document.getElementsByName('select_row');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    select_all_checkbox.addEventListener('change', function(event) {
        ...
        if (select_all_checkbox.checked === false) {
            deSelect();
        }
    });
    var checkbox_list = document.getElementsByName('select_row');
    for (var i in checkbox_list) {
        if (checkbox_list[i].type=='checkbox') {
            checkbox_list[i].addEventListener('change', function(event) {
