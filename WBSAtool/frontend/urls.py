...
urlpatterns = [
    ...
    path('appointment/bulk', views.appointment_bulk, name='appointment_bulk'),
    ...
    path('appointment/<int:appointment_id>/clearOverwrite', views.appointment_overwrite_remove, name='appointment_clearOverwrite'),
